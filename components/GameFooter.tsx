...
export default function GameFooter({ className = "" }: GameFooterProps) {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: "Decidrazz - The Ultimate Online Party Game",
          text: "Check out this awesome party game where friends compete to come up with the wittiest answers to hilarious scenarios!",
  ...
  const actionItems = [
    ...
    },
    {
      ...
      action: () =>
        window.open(
          "mailto:your-email@example.com?subject=Decidrazz Game Feedback",
          "_blank"
